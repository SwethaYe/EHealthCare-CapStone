...
class ProductAdd extends Component {
   ...
   handleSubmit = (event) => {
    ...
    axios.post("http://localhost:8002/product", details)
      .then((result) => {
  ...
  render() {
    return (
        ...
        <div className="sidebar">
            ...
            <Link to="/ProductView"><button className="btn btn-link">View Medicine</button></Link>
                <Link to="/ProductAdd"><button className="btn btn-link">Add Medicine</button></Link>
                <Link to="/ProductDelete"><button className="btn btn-link">Delete Medicine</button></Link>
                <Link to="/ProductEdit"><button className="btn btn-link">Edit Medicine</button></Link> 
                <Link to="/ProductSearch"><button className="btn btn-link">Medicine Search</button></Link> 
                <Link to="/UserView"><button className="btn btn-link">UserView</button></Link>     
                <Link to="/GenerateReport"><button className="btn btn-link">Generate Report</button></Link>        
        </div>
        ...
        <div className="content">
            ...
            <div className="container">
                ...
                <br /><br />
                        <h2 className="display-5 fw-bold">Add_Medicine</h2>
                        <br />
